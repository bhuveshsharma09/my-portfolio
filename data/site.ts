export const siteConfig = {
  ...
  keyFacts: [
    ...
    { label: "Studying", value: "MTech AI Systems · NUS-ISS" },
    { label: "Previously", value: "Oracle JMS · 3.5 yrs" },
  ],

  aboutPortrait: {
    src: "/projects/about-me/bhuvesh-portrait.jpg",
    alt: "Portrait of Bhuvesh",
  },

  personalImages: [
    { src: "/projects/about-me/bhuvesh-1.png", alt: "Bhuvesh, personal photo 1" },
    { src: "/projects/about-me/bhuvesh-2.png", alt: "Bhuvesh, personal photo 2" },
    { src: "/projects/about-me/bhuvesh-3.png", alt: "Bhuvesh walking through a cloister" },
