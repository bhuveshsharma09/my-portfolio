...
export function SkillsSection() {
  return (
    <section id="skills" className="scroll-mt-32 px-6 py-16 md:py-24">
      <div className="mx-auto w-full max-w-none">
        <SectionHeading
          eyebrow="Skills & Technologies"
          title="The toolkit, end to end."
          subtitle="Languages, frameworks, and infrastructure I reach for across software engineering, ML, and cloud."
        />
