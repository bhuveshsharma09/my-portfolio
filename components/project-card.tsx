  ...
  if (variant === "compact") {
    return (
      <div
        ...
        className={cn(
          "group relative cursor-pointer rounded-2xl bg-card p-4 transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring",
